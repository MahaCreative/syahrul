...
export default function Index(props) {
    ...
    const reload = useCallback(
        debounce((query) => {
            router.get(route("admin.pembayaran-pelanggan"), query, {
                preserveState: true,
                preserveScroll: true,
            });
        }, 150),
    ...
    const columns = [
...

        {
            ...
            wrap: true,
            selector: (row) =>
                moment(row.pesanan.created_at).format("DD-MMMM-YYYY"),
        },
        ...
        {
            name: "Tanggal Pembayaran berhasil",
            width: "190px",
            wrap: true,
            selector: (row) => moment(row.succeded_at).format("DD-MMMM-YYYY"),
        },
...
Index.layout = (page) => (
    <Authenticated children={page} title="Pembayaran Pelanggan" />
);
