...
export default function Show(props) {
    ...
    return (
        <div className="w-full px-4 md:px-8 lg:px-16 transition-all duration-300 ease-in-out py-6 relative z-[999]">
            ...
            <div className="my-3 px-3 rounded-md py-2 flex gap-4 flex-col md:flex-row bg-white">
                <img
                    src={"/storage/" + paket.gambar_paket}
                    alt=""
                    className="md:w-[250px] w-full object-cover transition-all duration-300 ease-in-out"
                />
                <div>
                    <h3 className="font-bold text-orange-500 capitalize text-xl">
                        {paket.nama_paket}
                    </h3>
                    <div className="flex justify-between items-center">
                        <p>
                            <CurrencyInput
                                ...
                                disabled
                                prefix="Rp. "
                                className="border-none bg-inherit  font-medium px-0"
                            />
                        </p>
                    ...
                    <p className="text-sm w-full md:w-[80%]">
            ...
            <h3 className="font-bold text-orange-500 text-base md:text-lg lg:text-xl ">
                Lihat Pesanan {paket.nama_paket}
            </h3>
...
Show.layout = (page) => <Authenticated children={page} title="Show Paket" />;
